...
plot(dat1@phylo, show.tip.label=FALSE)
plot(dat2@phylo, show.tip.label=FALSE) 
...
ggtree(dat1, aes(color=type)) + geom_tippoint()
ggtree(dat2, aes(color=type)) + geom_tippoint()
