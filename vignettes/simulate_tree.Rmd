...
dat1 <- sim_adb_origin_samp(t_or, scale,shape,d,rho,origin_type,Xi_as=Xi_as, Xi_s=Xi_s)
...
ggtree(dat1)+geom_point(aes(color=type), size=2)
ggtree(dat2)+geom_point(aes(color=type), size=2)
