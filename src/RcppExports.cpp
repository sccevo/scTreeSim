...
List sim_adb_origin_loop_cpp(double origin_time, NumericVector a, NumericVector b, NumericVector d, NumericMatrix Xi_as, NumericMatrix Xi_s, int origin_type);
RcppExport SEXP _scTreeSim_sim_adb_origin_loop_cpp(SEXP origin_timeSEXP, SEXP aSEXP, SEXP bSEXP, SEXP dSEXP, SEXP Xi_asSEXP, SEXP Xi_sSEXP, SEXP origin_typeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< NumericMatrix >::type Xi_s(Xi_sSEXP);
    Rcpp::traits::input_parameter< int >::type origin_type(origin_typeSEXP);
    rcpp_result_gen = Rcpp::wrap(sim_adb_origin_loop_cpp(origin_time, a, b, d, Xi_as, Xi_s, origin_type));
    return rcpp_result_gen;
END_RCPP
}
